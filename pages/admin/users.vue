  ...
  <div class="min-h-screen w-full bg-[#f5f6f1] font-sans">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
      ...
      <div class="flex-1 flex flex-col bg-slate-50">
        ...
        >
          <h1
            class="text-lg md:text-2xl font-bold text-[#31572c]"
          >
            Users Management
          </h1>
          <div class="flex items-center gap-3">
            <button
              class="w-9 h-9 md:w-12 md:h-12 rounded-full bg-[#588157] flex items-center justify-center text-white font-semibold shadow-md hover:bg-[#476747] transition-colors"
        ...
        <main class="flex-1 px-4 md:px-8 py-6 md:py-8 overflow-y-auto">
          ...
          >
            <button
              ...
              class="px-5 md:px-6 py-2.5 md:py-3 bg-[#588157] text-white rounded-2xl font-semibold hover:bg-[#476747] shadow-md transition-all flex items-center gap-2 text-sm md:text-base"
            >
              + Create User
            </button>
          </div>
              ...
              <table class="w-full text-sm min-w-[800px]">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td
                      class="px-4 py-3 text-slate-900 font-medium"
                    >
                      {{ user.username }}
                    </td>
                    ...
                    <td class="px-4 py-3 text-right">
                      ...
                      >
                        <button
                          class="p-1.5 rounded-full hover:bg-slate-100 text-blue-500 hover:text-blue-600"
                          title="View"
                        ...
                        <button
                          class="p-1.5 rounded-full hover:bg-slate-100 text-red-500 hover:text-red-600"
    ...
    <transition name="fade">
      ...
      >
        ...
        >
          ...
          >
            <div>
              <h3 class="text-xl font-bold text-[#31572c]">
                Create User Account
              </h3>
          ...
          >
            ...
            >
              <p
                class="text-xs font-medium text-blue-800 mb-2"
              >
                Login credentials:
              </p>
              <div
                class="text-xs space-y-1 text-blue-700"
              >
                <div>
                  <strong>Email:</strong>
                  {{ registerForm.email }}
    ...
    <transition name="fade">
      ...
      >
        <div
          class="bg-white rounded-3xl max-w-md w-full max-h-[70vh] overflow-hidden shadow-2xl"
        >
          <div
          ...
          >
            ...
            <button
              ...
              class="text-xl hover:text-slate-500"
            >
              ✕
            </button>
          </div>
            ...
            <div class="pt-4 border-t">
              ...
              >
                ...
                <div>
                  <strong>Password:</strong>
                  <span
                    class="font-mono bg-white px-2 py-1 rounded text-xs"
                    >(user sets own password)</span
                  >
                </div>
              </div>
            </div>
...
const deleteUser = userId => {
  ...
  createdUsers.value = createdUsers.value.filter(
    u => `created_${u.email}` !== userId
  )
}
